...
<div class="h-screen bg-gray-100 sm:ml-64">
    ...
    <div class="w-full pb-20 min-h-40">
        ...
        <div class="container p-10 pb-8 md:px-8 lg:px-11">
            <div class="relative overflow-x-auto bg-white rounded-lg shadow-lg shadow-gray-400">
                    ...
                    <div class="lg:p-6 p-6 border-b-3 rounded-[5px] w-full">
                        <div class="flex justify-between  mb-4 mt-[0px]">
                            ...
                            <form class="flex items-center" action="/laporanPeminjaman" method="get">
                                ...
                                <button type="submit"
                                    class="p-2 ml-2 text-sm font-medium text-white bg-blue-700 rounded-lg border hover:bg-[#ffd102] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        ...
                        <div>
                            <button type="button"
                                class="text-white flex item-center  bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-[3px] text-base 
                                            px-2 py-1.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                <p class="px-2"> Tambah data</p>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24">
                                    <path
                                        fill="currentColor"d="M11 13v3q0 .425.288.713T12 17q.425 0 .713-.288T13 16v-3h3q.425 0 .713-.288T17 12q0-.425-.288-.713T16 11h-3V8q0-.425-.288-.713T12 7q-.425 0-.713.288T11 8v3H8q-.425 0-.713.288T7 12q0 .425.288.713T8 13h3Zm1 9q-2.075 0-3.9-.788t-3.175-2.137q-1.35-1.35-2.137-3.175T2 12q0-2.075.788-3.9t2.137-3.175q1.35-1.35 3.175-2.137T12 2q2.075 0 3.9.788t3.175 2.137q1.35 1.35 2.138 3.175T22 12q0 2.075-.788 3.9t-2.137 3.175q-1.35 1.35-3.175 2.138T12 22Z" />
                                </svg>
                            </button>
                        </div>
                        ...
                        <div class="relative mb-3 overflow-x-auto">
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    class="text-sm text-center text-gray-700 bg-gray-300 dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                                ...
                                <tbody>
                                    <tr
                                        class="text-left text-black bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        <th scope="row"
                                        ...
                                        <td class="px-3 py-2 font-medium">
                                            Rancang Bangun Sistem Informasi Pendaftaran Seminar Proposal, Skripsi dan
                                            Yudisium
                                        ...
                                        <td
                                            class="relative flex items-center justify-center px-3 py-3 font-medium text-right border-slate-200">
                                            <button type="button"
                                                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-[3px] text-sm px-2 py-2 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                            ...
                                            <button type="button"
                                                class="text-white bg-green-700 hover:bg-red-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-[3px] text-sm px-2 py-2 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            ...
                                            <button type="button"
                                                class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-[3px] text-sm px-2 py-2 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
