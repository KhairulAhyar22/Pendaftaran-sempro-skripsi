                                ...
                                <div class="grid grid-cols-1 mb-5 lg:grid-cols-2 lg:mx-10 gap-7 ">
                                    ...
                                    <div class="mb-3">
                                        <label for="anggota4"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                            Anggota</label>
                                        <select id="anggota4" name="anggota4"
                                            class="{{ $errors->has('anggota4') ? 'bg-red-50 border border-red-500' : 'bg-gray-50 border border-gray-300' }} block w-full p-2.5 text-sm text-gray-900 border rounded-lg  focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            required>
                                            <option selected></option>
