            ...
            <div class="relative overflow-x-auto bg-white border rounded-lg">
                <div class="flex w-full">
                    <div class="w-full rounded-lg border-b-3">
                        ...
                        <form action="/jadwal/ujianskripsi/store" method="post" class="" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="grid grid-cols-1 mb-5 lg:grid-cols-2 lg:mx-10 gap-7 ">
                                    <div class="mb-3">
                                        <label for="nama_mahasiswa"
                                            ...
                                            Mahasiswa</label>
                                        <select id="id_proposal" name="id_skripsi" onchange="redirectToById(this)"
                                            ...
                                            @foreach ($listskripsi as $sempro)
                                                <option value="{{ $sempro->id }}" {{ $sempro->id == $skripsibyid->id ? 'selected' : '' }}>{{ $sempro->nama_mahasiswa }} /
                                                    {{ $sempro->nim }}</option>
                                            @endforeach
                                        </select>
                                        <script>
                                  ...
                                  <div class="mb-3">
                                        <input type="text" name="ketua_tim" hidden value="{{ $skripsibyid->pembimbing1 }}">
                                        <label for="pembimbing1"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                            Pembimbing Utama (Ketua Tim)</label>
                                        <input type="text" id="pembimbing1" disabled name="pembimbing1" value="{{ $skripsibyid->pembimbing1 }}"
                                            placeholder="{{ $skripsibyid->pembimbing1 }}"
                                            class="{{ $errors->has('pembimbing1') ? 'bg-red-50 border border-red-500' : 'bg-gray-50 border border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            >
                                        @error('pembimbing1')
                                            <div class="text-xs text-red-500">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        <input type="text" name="anggota1" hidden value="{{ $skripsibyid->pembimbing2 }}">
                                        <label for="pembimbing2"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                            Pembimbing Kedua (Anggota)</label>
                                        <input type="text" id="pembimbing2" disabled name="pembimbing2" value="{{  $skripsibyid->pembimbing2 }}"
                                            placeholder="{{ $skripsibyid->pembimbing2 }}"
                                            class="{{ $errors->has('pembimbing2') ? 'bg-red-50 border border-red-500' : 'bg-gray-50 border border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            >
                                        @error('pembimbing2')
                                            <div class="text-xs text-red-500">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        <label for="anggota2"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                            Anggota</label>
                                        <select id="anggota2" name="anggota2"
                                            class="{{ $errors->has('anggota2') ? 'bg-red-50 border border-red-500' : 'bg-gray-50 border border-gray-300' }} block w-full p-2.5 text-sm text-gray-900 border rounded-lg  focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            required>
                                    ...
                                    <div class="mb-3">
                                        <label for="anggota3"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                            Anggota</label>
                                        <select id="anggota3" name="anggota3"
                                            class="{{ $errors->has('anggota3') ? 'bg-red-50 border border-red-500' : 'bg-gray-50 border border-gray-300' }} block w-full p-2.5 text-sm text-gray-900 border rounded-lg  focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            required>
                                            <option selected></option>
                                            @foreach ($daftardosen as $dosen)
                                                <option value="{{ $dosen->nama_dosen }}">{{ $dosen->nama_dosen }}
                                    ...
                                    <div class="mb-3">
                                        <label for="waktu_mulai"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Waktu_mulai</label>
                                        <input type="time" id="waktu_mulai" name="waktu_mulai" value="{{ old('waktu_mulai') }}"
                                            placeholder="Write waktu_mulai here..."
                                            class="{{ $errors->has('waktu_mulai') ? 'bg-red-50 border border-red-500' : 'bg-gray-50 border border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            required>
                                        @error('waktu_mulai')
                                            <div class="text-xs text-red-500">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        <label for="waktu_selesai"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Waktu_selesai</label>
                                        <input type="time" id="waktu_selesai" name="waktu_selesai" value="{{ old('waktu_selesai') }}"
                                            placeholder="Write waktu_selesai here..."
                                            class="{{ $errors->has('waktu_selesai') ? 'bg-red-50 border border-red-500' : 'bg-gray-50 border border-gray-300' }} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            required>
                                        @error('waktu_selesai')
                                            <div class="text-xs text-red-500">{{ $message }}</div>
                                        @enderror
