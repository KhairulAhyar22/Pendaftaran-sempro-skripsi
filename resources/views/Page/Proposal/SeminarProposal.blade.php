...
@section('content')
    <div class="text-center w-full ml-0 bg-gray-100 pb-20 min-h-screen sm:pl-[260px]">
        ...
        <div class="w-auto mx-7 bg-yellow-300 border-b-2 border-gray-300 rounded-lg shadow-lg mt-11 p-3 ">
                                ...
                                <tbody>
                                    @foreach ($datas as $data)
                                        <tr
                                            ...
                                            <th scope="row"
                                                class="px-2.5 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                {{ $loop->iteration }}
                                            </th>
