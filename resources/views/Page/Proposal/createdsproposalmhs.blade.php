...
<body>
    ...
    <div class="w-full ml-0 bg-gray-100 pb-20 min-h-screen  pt-11">
        ...
        <div class="w-auto py-3 text-center bg-yellow-300 border-b-2 border-gray-300 rounded-lg shadow-lg mx-7">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="flex items-center mb-4">
                                                <input id="regular" type="radio" name="status_mahasiswa"
                                                    value="Regular"
                                                    class="w-4 h-4 border-gray-400 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" required>
                                                <label for="regular"
