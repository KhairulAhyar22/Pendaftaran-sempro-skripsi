            ...
            <div class="relative pb-10 overflow-x-auto bg-white border rounded-lg">
                <div class="flex w-full">
                    <div class="w-full rounded-lg border-b-3">
                        ...
                        <p class="px-6 py-2 pt-2 font-medium text-white rounded-t-lg lg:mx-10 bg-emerald-700">Kelengkapan Berkas Pendaftaran (<span class="font-normal"> Diverifikasi oleh staff program studi</span>)</p>
                            <div class="px-6 mb-5 border border-gray-300 rounded shadow-xl lg:mx-10 dark:border-gray-700">                              
                                <div class="flex my-4">
                                    ...
                                    <div class="ml-2 text-sm">
                                        <label for="helper-checkbox"
                                            ...
                                            class="text-sm font-normal text-gray-500 dark:text-gray-300">(Hasil cetak/print KRS berjalan dan telah ditanda tangani oleh ketua program studi)
                                        </span>
                                            <div class="pt-2">                                            
                                                <a href="/Dokument/Proposal/KRS/{{ $file->file_krs }}" target="_blank" class="pt-2 font-semibold text-slate-700 hover:font-medium hover:text-slate-800"> {{ $file->file_krs ? $file->file_krs : '-'}}</a>
                                             </div>
                                     </div>
                                    </div>
                                ...
                                <div class="flex my-6">
                                    ...
                                    <div class="ml-2 text-sm">
                                        <label for="helper-checkbox"
                                            ...
                                            Konsul </label>
                                        <span id="helper-checkbox-text"
                                            class="text-sm font-normal text-gray-500 dark:text-gray-300"> (Mengumpulkan kartu konsultasi yang memiliki keterangan telah disetujui oleh kedua pembimbing dan telah menghadiri minimal 10 seminar penelitian)</span>
                                         <div class="pt-2">                                            
                                                <a href="/Dokument/Proposal/KRS/{{ $file->file_krs }}" target="_blank" class="pt-2 font-semibold text-slate-700 hover:font-medium hover:text-slate-800"> {{ $file->file_krs ? $file->file_krs : '-'}}</a>
                                         </div>
                                    </div>
                                ...
                                <div class="flex my-6">
                                    ...
                                    <div class="ml-2 text-sm">
                                        <label for="helper-checkbox"
                                            class="font-medium text-gray-900 dark:text-gray-300">Mengumpulkan Foto Copy KTM </label>
                                    </div>
                                </div>
                                <div class="flex my-6">
                                    <div class="flex items-center h-5">
                                ...
                                <div class="flex my-6">
                                    ...
                                    <div class="ml-2 text-sm">
                                        <label for="helper-checkbox"
                                            class="font-medium text-gray-900 dark:text-gray-300">Mengumpulkan Keterangan Lunas SPP </label>
                                            <div class="pt-2">                                            
                                                <a href="/Dokument/Proposal/KRS/{{ $file->file_krs }}" target="_blank" class="pt-2 font-semibold text-slate-700 hover:font-medium hover:text-slate-800"> {{ $file->file_krs ? $file->file_krs : '-'}}</a>
                                         </div>
                                    </div>
                                ...
                                <div class="flex my-6">
                                    ...
                                    <div class="ml-2 text-sm">
                                        <label for="helper-checkbox"
                                            class="font-medium text-gray-900 dark:text-gray-300">Mengumpulkan Slip Pembayaran Semester Berjalan </label>
                                            <div class="pt-2">                                            
                                                <a href="/Dokument/Proposal/KRS/{{ $file->file_krs }}" target="_blank" class="pt-2 font-semibold text-slate-700 hover:font-medium hover:text-slate-800"> {{ $file->file_krs ? $file->file_krs : '-'}}</a>
                                         </div>
                                    </div>
                                ...
                                <div class="flex my-4">
                                    ...
                                    <div class="ml-2 text-sm">
                                            ...
                                            <span id="helper-checkbox-text"
                                                class="text-sm font-normal text-gray-500 dark:text-gray-300">Mengumpulkan proposal 2 rangkap yang telah di jilid warna merah </span>
                            ...
                            <div class="flex justify-start my-8 lg:mx-10 ">
                              <a href="/proposal"
                                ...
                                <a href="/proposal"class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 
