...
<head>
    ...
    <link href="asset/css/all.css" rel="stylesheet" <!-- Icons -->
...
<div class="sm:ml-64 bg-gray-100 h-full">
    ...
    <div
        class="border p-10 shadow-xl bg-white mx-28 my-12 rounded-lg shadow-gray-400 grid grid-cols-2 gap-0 md:grid md:grid-cols-3 md:gap-0">
        <div class="col-span-2">
            <div class="py-3">
                <p class="text-lg"> Hasil cetak/print KRS berjalan dan telah ditanda tangani oleh ketua program studi
                </p>
                <input type="file"class="border border-gray-500 w-full rounded">
            </div>

            <div class="py-3">
                <p class="text-lg"> Fotocopy kartu konsultasi yang memiliki keterangan telah disetujui oleh kedua
            ...
            <div class="py-3">
                <p class="text-lg"> Hasi cetak/print KRS sementara berjalan dan telah ditanda tangani oleh kedua program
                    studi.</p>
                <input type="file" class="border border-gray-500 w-full rounded">
            </div>
            ...
            <div class="py-3">
                <p class="text-lg"> Fotocopy slip pembayaran semester berjalan.</p>
                <input type="file" class="border border-gray-500 w-full rounded">
            </div>
            ...
            <div class="flex justify-end">
                ...
                font-medium rounded-xl text-sm px-5 py-2.5 text-center mr-2 my-5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Upload
                    File
                </button>
            </div>
        </div>
