            ...
            <div class="relative overflow-x-auto bg-white rounded-lg border">
                <div class="flex w-full">
                    <div class="border-b-3 rounded-lg w-full">
                        ...
                        <form action="/skripsi/store/dokumentpersyaratan/{{ $skripsi->id }}" method="post" class=""
                            ...
                            <div class="lg:p-6 p-6 ">
                                <div class="grid grid-cols-1 lg:grid-cols-1 lg:mx-10 gap-7 mb-5 ">
                                    <div class="mb-3">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_form_help">Hasil
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_bukti_acc_help">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="file_pengesahan_proposal" value="{{ old('file_pengesahan_proposal') }}"
                                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                            aria-describedby="file_pengesahan_proposal_help" id="file_pengesahan_proposal"
                                            type="file">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300"
                                            id="file_kartu_konsul_help">Hasil cetak/print KRS semester berjalan dan telah
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="file_bukti_lunasspp"
                                            value="{{ old('file_bukti_lunasspp') }}"
                                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
