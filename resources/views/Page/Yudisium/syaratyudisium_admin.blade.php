                        ...
                        <div class="flex w-full">
                            <div class="lg:p-6 p-6 border-b-3 rounded-[5px] w-full">
								<div class="flex justify-between  mb-4 mt-[0px]">
									...
									<form class="flex items-center" action="/laporanPeminjaman" method="get">
										...
										<div class="relative w-full">
											...
											<input type="text" id="simple-search" name="search" value="{{ request('search') }}" class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search">
										</div>
										<button type="submit" class="p-2 ml-2 font-medium text-white bg-blue-700 border rounded-lg text-md focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                ...
                                <div class="relative mb-3 overflow-x-auto border rounded-md shadow-lg shadow-gray-400">
									<table class="w-full text-left text-gray-500 text-md dark:text-gray-400">
										<thead class="text-center text-gray-700 bg-gray-300 text-md dark:bg-gray-700 dark:text-gray-400">
											<tr>
										...
										<tbody>
												<tr class="text-center text-black bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                    ...
                                                    <button type="button" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-[3px] text-sm 
                                                        px-[16px] py-[8px] mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">
