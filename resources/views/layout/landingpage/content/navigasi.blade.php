<nav class="bg-dark-green fixed top-0 left-0 w-screen z-50 drop-shadow">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4  py-2">
        ...
        <div class="hidden w-screen md:block md:w-auto" id="navbar-default">
            <ul
                class="font-medium flex flex-col p-4 md:p-0 mt-4  items-center rounded-lg  md:flex-row md:space-x-8 md:mt-0 ">
                <li>
                    <a href="#home"
                ...
                <li>
                    <div class="text-white text-center items-center">
                        <button id="" data-dropdown-toggle="dropdownlogout"
                            class="inline-flex items-center px-3 py-2 text-sm text-center  " type="button">
                        ...
                        <div id="dropdownlogout"
                            ...
                            <ul class="py-2 text-sm font-medium text-gray-700 " aria-labelledby="dropdownDefaultButton">
                                <li>
                                    <a href="/logout"
