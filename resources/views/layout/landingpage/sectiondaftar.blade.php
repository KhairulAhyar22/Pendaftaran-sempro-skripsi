                ...
                @if ($statusSempro == 'Selesai')
                    @if (count($skripsi) == 0)
                        ...
                        <a href="/skripsi/create/mhs"
                            ...
                            <p class="ml-2 mb-2 text-xl font-semibold tracking-tight text-yellow-600 dark:text-white">
                                Daftar Skripsi</p>
                        </a>
                    @else
                        <a onclick="return alert('Tidak dapat melakukan pendaftaran, pendaftaran telah terbuat sebelumnya')"
                    ...
                    @endif
                @else
                    <a onclick="return alert('Anda harus menyelesaikan Seminar Proposal terlebih dahulu')"
                        class="flex flex-row items-center p-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:bg-blue-50 w-96">
                        <svg class="w-6 h-6 text-yellow-600 dark:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" width="18" height="20" fill="none"
                            viewBox="0 0 18 20">
                ...
                @if ($statusSkripsi == 'Selesai')
                    @if (count($yudisium) == 0)
                        <button id="daftaryudis" data-dropdown-toggle="dropdownyudis"
                            ...
                            <p class="ml-2 mb-2 text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
                                Daftar
                                Yudisium</p>
                        </button>
                                        ...
                                        <div class="mb-3 px-3">
                                            <form action="/yudisium/store" method="POST"
                                                ...
                                                <input name="file_PPT_yudis"
                                                    ...
                                                    aria-describedby="file_PPT_yudis_help" id="file_PPT_yudis"
                                                    type="file">
                                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300"
                                                    id="file_PPT_yudis_help">
                                                    Gunakan template PPT yudisium yang di sediakan, jika belum ada,
                                                    silahkan
                    ...
                    @else
                        <a onclick="return alert('Anda sudah mendaftar! hanya dapat mendaftar 1 kali! jika masih terkendala silahkan hubungi admin')"
                            class=" flex flex-row items-center p-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:bg-blue-50 w-96 ">
                            <svg class="w-6 h-6 text-green-600 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="18" height="20" fill="none"
                                viewBox="0 0 18 20">
                            ...
                            <p class="ml-2 mb-2 text-xl font-semibold tracking-tight text-green-600 dark:text-white">
                                Daftar
                                Yudisium
                            </p>
                        </a>
                    @endif
                @else
                    <a onclick="return alert('Tidak dapat melakukan pendaftaran, Harus Selesai Ujian Skripsi')"
                        class=" flex flex-row items-center p-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:bg-blue-50 w-96 ">
                        <svg class="w-6 h-6 text-green-600 dark:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" width="18" height="20" fill="none"
                            viewBox="0 0 18 20">
