                    ...
                    <div id="default-carousel" class="relative w-full  " data-carousel="slide">
                        ...
                        <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                            ...
                            <div class="hidden duration-1000 bg-white ease-in-out " data-carousel-item>
                                <div
                                    class="w-full h-full p-4 bg-white border  rounded-lg shadow sm:p-8  ">
                                    <h5 class="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">Persyartan Seminar Proposal
                                    </h5>
                            ...
                            <div class="hidden duration-1000 bg-white ease-in-out " data-carousel-item>
                                <div
                                    class="w-full h-full p-4 bg-white border  rounded-lg shadow sm:p-8  ">
                                    <h5 class="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">Persyartan Uijan Skripsi
                                    </h5>
                                    <ul role="list" class="space-y-3 my-2">
                                        <li class="flex space-x-3 items-center">
                                            <svg class="flex-shrink-0 w-4 h-4 text-blue-600 dark:text-blue-500"
                            ...
                            <div class="hidden duration-1000 bg-white ease-in-out " data-carousel-item>
                                <div class="w-full h-full p-4 bg-white border  rounded-lg shadow sm:p-8  ">
                                    ...
                                    <ul role="list" class="space-y-3 my-1">
                                        ...
                                        <li class="flex space-x-3">
                                            <svg class="flex-shrink-0 w-4 h-4 text-green-800 " aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                viewBox="0 0 20 20">
                                                <path
                                                    d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                                            </svg>
                                            <span class="text-base font-normal leading-tight text-gray-900 ">Fotocopy
                                                kartu konsultasi yang memiliki keterangan telah disetujui oleh kedua
                                                pembimbing dan telah menghadiri minimal 10 seminar penelitian </span>
                                        </li>
                                        <li class="flex space-x-3">
                                            <svg class="flex-shrink-0 w-4 h-4 text-green-800 " aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                            ...
                                            <span class="text-base font-normal leading-tight text-gray-900 ">Fotocopy
                                                KRS semester yang berjalan dan telah ditandatangani oleh ketua program
                                                studi</span>
                                        </li>
                                        <li class="flex space-x-3">
                                            <svg class="flex-shrink-0 w-4 h-4 text-green-800 " aria-hidden="true"
                                        ...
                                        <li class="flex space-x-3">
                                            ...
                                            <span class="text-base font-normal leading-tight text-gray-900 ">Surat
                                                keterangan lunas SPP (Dari Keuangan)</span>
                                        </li>
                                        <li class="flex space-x-3">
                                            <svg class="flex-shrink-0 w-4 h-4 text-green-800 " aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                            ...
                                            <span
                                                class="text-base font-normal leading-tight text-gray-900 ">Mengumpulkan
                                                2 rangkap proposal yang telah dijilid (warna merah)</span>
                                        </li>
                                        <li class="flex space-x-3">
                                            <svg class="flex-shrink-0 w-4 h-4 text-green-800 " aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                            ...
                                            <span class="text-base font-normal leading-tight text-gray-900 ">Formulir
                                                Pendaftaran Seminar Proposal</span>
                                        </li>
                                        <li class="flex space-x-3">
                                            <svg class="flex-shrink-0 w-4 h-4 text-green-800 " aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                ...
                                <div class="w-full h-full p-4 bg-white border  rounded-lg shadow sm:p-8  ">
                                    ...
                                    <ul role="list" class="space-y-3 my-1">
                                        <li class="flex space-x-3 items-center">
                                            ...
                                            <span class="text-base font-normal leading-tight text-gray-900 ">Menyiapkan
                                                Kelengkapan Berkas berikut :</span>
                                        </li>
                                        <li class="flex space-x-3">
                                            <svg class="flex-shrink-0 w-4 h-4 text-green-800 " aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                            ...
                                            <span class="text-base font-normal leading-tight text-gray-900 ">Hasil Print
                                                Pengisian Formulir Pendaftaran ujian skripsi</span>
                                        </li>
                                        <li class="flex space-x-3">
                                            <svg class="flex-shrink-0 w-4 h-4 text-green-800 " aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                            ...
                                            <span
                                                class="text-base font-normal leading-tight text-gray-900 ">Mengumpulkan
                                                hasil cetak skripsi yang telah acc uji similarity (4 rangkap)</span>
                                        </li>
                                        <li class="flex space-x-3">
                                            <svg class="flex-shrink-0 w-4 h-4 text-green-800 " aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                            ...
                                            <span
                                                class="text-base font-normal leading-tight text-gray-900 ">Mengumpulkan
                                                Hasil Cetak Bukti acc skripsi dari kedua pembimbing</span>
                                        </li>
                                        <li class="flex space-x-3">
                                            <svg class="flex-shrink-0 w-4 h-4 text-green-800 " aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                            ...
                                            <span
                                                class="text-base font-normal leading-tight text-gray-900 ">Mengumpulkan
                                                Surat Keterangan Persetujuan ujian skripsi dari ketua prodi</span>
                                        </li>
                                        <li class="flex space-x-3">
                                            <svg class="flex-shrink-0 w-4 h-4 text-green-800 " aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                        ...
                                        <li class="flex space-x-3">
                                            ...
                                            <span class="text-base font-normal leading-tight text-gray-900 ">Fotocopy
                                                KRS semester berjalan dan telah ditanda tangani oleh program
                                                studi</span>
                                        </li>
                                        <li class="flex space-x-3">
                                            <svg class="flex-shrink-0 w-4 h-4 text-green-800 " aria-hidden="true"
                                ...
                                <div class="w-full h-full p-4 bg-white border  rounded-lg shadow sm:p-8  ">
                                    ...
                                    <ul role="list" class="space-y-3 my-1">
                                        ...
                                        <li class="flex space-x-3">
                                            ...
                                            <span class="text-base font-normal leading-tight text-gray-900 ">Hasil
                                                Print Pengisian Formulir Pendaftaran ujian skripsi</span>
                                        </li>
                                        <li class="flex space-x-3">
                                            <svg class="flex-shrink-0 w-4 h-4 text-green-800 " aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                    ...
                    <div class="p-5 mx-auto bg-white rounded-xl w-96 h-96 ">
                        <div class="mb-7">
                            <h3 class="text-xl font-bold text-slate-800-800">Selamat Datang <br> <i
                                    class="text-base font-light">Nama mahasiswa yg login</i> </h3>
                        </div>
