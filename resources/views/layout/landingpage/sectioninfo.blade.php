            ...
            @if (count($proposal) === 0)
                <div class="flex w-full">
                    <div class="w-full rounded-lg border-b-3">
                        ...
                        <p class="my-5 text-center">Data daftar seminar proposal belum dibuat, silahkan lakukan daftar
                            terlebih dahulu</p>
                    </div>
                </div>
            @endif
                ...
                <div class="flex w-full">
                    <div class="w-full rounded-lg border-b-3">
                        ...
                        <div class="px-8 py-3 rounded-t-lg bg-emerald-700">
                            <h3 class="text-lg font-medium text-white">Daftar Proposal {{ $data->id }}</h3>
                        </div>
                                ...
                                <div id="dropdown{{ $data->id }}"
                                    ...
                                    <ul class="py-2 text-sm font-medium text-gray-700 dark:text-gray-200"
                                        ...
                                        <li>
                                            ...
                                            @else
                                            <button onclick="return alert('Anda Belu Dijadwalkan seminar proposal, mohon tunggu atau hubungi staff prodi!')"
                                                class="block px-4 py-[7px] text-orange-500 hover:bg-gray-100  justify-end">
                                                <div class="flex items-center justify-end mx-auto w-28">
                                                    <iconify-icon icon="ic:round-download"
                                                        class="text-[20px] mr-2"></iconify-icon>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr
                                ...
                                <td class="px-4 py-4">
                                    <a href="/Dokument/Proposal/Proposal/{{ $data->file_proposal }}" target="_blank"
                                ...
                                <td class="px-4 py-4">
                                    <a href="/Dokument/Proposal/LunasSPP/{{ $data->file_lunas_spp }}" target="_blank"
            ...
            @foreach ($skripsi as $data)
                <div class="flex w-full">
                    <div class="w-full rounded-lg border-b-3">
                        ...
                        <div class="px-8 py-3 rounded-t-lg bg-emerald-700">
                            <h3 class="text-lg font-medium text-white">Daftar Skripsi {{ $data->id }}</h3>
                        </div>
                        <div class="flex justify-between  mt-5 ">
                            <div class="">
                                @if ($data->status == 'Terbuat')
                            ...
                            <div class="grid grid-cols-1 mb-0 lg:grid-cols-2 lg:mx-10 gap-7 ">
                                ...
                                <div class="">
                                    <div class="flex-col sm:flex md:justify-start">
                                        ...
                                        <h3 class="block text-base font-semibold text-gray-900 dark:text-white">Screenshoot Uji Similarity :
                                        </h3>
                                        <a href="/Dokument/Skripsi/UjiSimilarity/{{ $data->uji_similarity }}" target="_blank"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr
                                ...
                                <td class="px-4 py-4">
                                    <a href="/UjianSkripsi/KTM{{ $data->file_ktm }}"
                                        target="_blank"
