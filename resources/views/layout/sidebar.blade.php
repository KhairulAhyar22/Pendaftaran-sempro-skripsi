    ...
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto mt-5">
        ...
        <div class="h-full px-6 py-6 overflow-y-auto ">
            <ul class="space-y-2 font-medium text-sm">
                <li>
                    <a href="/dashboard"
                        class="flex items-center  text-white gap-x h-[40px] px-2 hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <li >
                        <a href="/jadwal/ujianskripsi"
                         ...
                         <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                            ...
                            <span class="ml-2">Jadwal Ujian Skripsi</span></a>
                    </li>
                @endif
                @if (auth()->user()->level == 'Prodi')
                    <li>
                        <a href="/yudisium"
                            ...
                            <span class="ml-2">Kelola Yudisium</span>
                        </a>
                    </li>
                @endif
                    ...
                    <li class="list-none ">
                        <button type="button"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap " sidebar-toggle-item>Kelola
                                jadwal</span>
                            <svg id="dropdown-icon-jadwal"xmlns="http://www.w3.org/2000/svg" class=""
                        ...
                        <ul id="dropdown-menu-jadwal" class="hidden ">
                            ...
                            <li class="p-1.5 list-none">
                                ...
                                <a href="/jadwal/seminarproposal"
                                    class="flex items-center w-full text-white transition duration-75 rounded-lg pl-8 group hover:bg-emerald-800 hover:text-black">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                        viewBox="0 0 24 24">
                                        <path fill="currentColor"
                                            d="M12 4.25q.325 0 .537-.213t.213-.537q0-.325-.213-.537T12 2.75q-.325 0-.537.213t-.213.537q0 .325.213.537T12 4.25ZM18 23q-2.075 0-3.538-1.463T13 18q0-2.075 1.463-3.538T18 13q2.075 0 3.538 1.463T23 18q0 2.075-1.463 3.538T18 23Zm-.5-2h1v-2.5H21v-1h-2.5V15h-1v2.5H15v1h2.5V21ZM7 9h10V7H7v2Zm4.675 12H3V3h6.2q.325-.9 1.088-1.45T12 1q.95 0 1.713.55T14.8 3H21v8.7q-.725-.35-1.463-.525T18 11q-.275 0-.513.013t-.487.062V11H7v2h6.125q-.45.425-.813.925T11.675 15H7v2h4.075q-.05.25-.063.488T11 18q0 .825.15 1.538T11.675 21Z" />
                                    </svg>
                                    <span class="ml-2">Seminar</span></a>
                            </li>

                            <li class="p-1.5 list-none">
                                <a href="/jadwal/ujianskripsi"
                                    class="flex items-center w-full text-white transition duration-75 rounded-lg pl-8 group hover:bg-green-800 hover:text-black">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                        viewBox="0 0 24 24">
                                        <path fill="currentColor"
                                            d="M12 4.25q.325 0 .537-.213t.213-.537q0-.325-.213-.537T12 2.75q-.325 0-.537.213t-.213.537q0 .325.213.537T12 4.25ZM18 23q-2.075 0-3.538-1.463T13 18q0-2.075 1.463-3.538T18 13q2.075 0 3.538 1.463T23 18q0 2.075-1.463 3.538T18 23Zm-.5-2h1v-2.5H21v-1h-2.5V15h-1v2.5H15v1h2.5V21ZM7 9h10V7H7v2Zm4.675 12H3V3h6.2q.325-.9 1.088-1.45T12 1q.95 0 1.713.55T14.8 3H21v8.7q-.725-.35-1.463-.525T18 11q-.275 0-.513.013t-.487.062V11H7v2h6.125q-.45.425-.813.925T11.675 15H7v2h4.075q-.05.25-.063.488T11 18q0 .825.15 1.538T11.675 21Z" />
                                    </svg>
                                    <span class="ml-2">Skripsi</span></a>
                            </li>

                            <li class="p-1.5 list-none">
                                <a href="/jadwal/yudisium"
                                    class="flex items-center w-full text-white transition duration-75 rounded-lg pl-8 group hover:bg-green-800 hover:text-black">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                        viewBox="0 0 24 24">
                                        <path fill="currentColor"
                                    ...
                                    <span class="ml-2">Yudisium</span></a>
                            </li>
                ...
                <li>
                    <form action="/logout">
                        ...
                        <button type="submit" onclick="return confirm ('Yakin ingin keluar')"
                            class="flex items-center  mt-36  gap-x h-[40px] px-4 text-white hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24">
                                <path fill="currentColor"
